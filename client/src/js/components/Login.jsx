...
<div className="row">
    <div className="col-sm-6 col-md-4 col-md-offset-4">
        <h1 className="text-center login-title">Sign in to GIT-HUB</h1>
        <div className="account-wall">
            <img className="profile-img" src="http://hammerjs.github.io/assets/img/github-icon.png"
                alt=""/>
            <form className="form-signin">
            <input type="text" className="form-control" placeholder="Username" required autofocus/>
            <input type="password" className="form-control" placeholder="Password" required/>
            <button className="btn btn-lg btn-primary btn-block" type="submit" onClick={this.loginFunction}>
                Sign in</button>
            <label className="checkbox pull-left">
                <input type="checkbox" value="remember-me"/>
                Remember me
            </label>
            <a href="#" className="pull-right need-help">HELP?</a><span className="clearfix"></span>
            </form>
        </div>
        <a href="#registerModal" className="text-center new-account" data-toggle="modal" >Register </a>
    </div>
</div>
                ...
                <section className = "modal fade" id="registerModal">
                    ...
                    <section className = "modal-content">
                        ...
                        <article className="modal-footer">
                            <input type = "submit" className = "btn btn-primary" data-dilgiss = "modal" value ="Register" onClick = {this.registerUser}/>
                        </article>
                    </section>
                </article>
                </section>
